...
export default function Community() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: '#0f1a0a' }}>
      ...
      {/* Telegram kanal va guruh */}
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-2">
        <motion.p
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-center text-stone-400 text-sm font-medium tracking-widest uppercase mb-4"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <motion.a
            ...
            viewport={{ once: true }}
            className="group flex items-center gap-4 p-4 rounded-2xl border border-blue-700/30 hover:border-blue-500/60 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-900/20"
            style={{ background: 'linear-gradient(135deg, #0d1b35 0%, #0f1a0a 100%)' }}
          >
            ...
            <div className="min-w-0">
              <p className="text-white font-semibold text-sm">IELTS Way Channel</p>
              <p className="text-blue-400/70 text-xs mt-0.5">@IELTSway_channel</p>
              <p className="text-stone-500 text-xs mt-1">
                {lang === 'uz' ? 'Yangiliklar va materiallar' : 'News & materials'}
              </p>
            </div>
            <svg className="w-4 h-4 text-stone-600 group-hover:text-blue-400 ml-auto flex-shrink-0 transition-colors duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <motion.a
            ...
            className="group flex items-center gap-4 p-4 rounded-2xl border border-green-800/30 hover:border-green-500/60 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-900/20"
            style={{ background: 'linear-gradient(135deg, #0d2018 0%, #0f1a0a 100%)' }}
          >
            ...
            <div className="min-w-0">
              <p className="text-white font-semibold text-sm">IELTS Way Guruh</p>
              <p className="text-green-400/70 text-xs mt-0.5">@ieltsway_tm</p>
              <p className="text-stone-500 text-xs mt-1">
                {lang === 'uz' ? 'Savol va muhokama' : 'Q&A & discussion'}
              </p>
            </div>
            <svg className="w-4 h-4 text-stone-600 group-hover:text-green-400 ml-auto flex-shrink-0 transition-colors duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M5 12h14M12 5l7 7-7 7"/>
            </svg>
          </motion.a>
        </div>
